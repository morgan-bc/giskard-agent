...
class BackgroundAgentsProvider(ContextProvider):
    ...
    def __init__(
        ...
        *,
        ...
        self.agents = _validate_and_build_agent_dict(agents)
        ...
        agent_list_text = _build_agent_list_text(self.agents)
