...
.. code-block:: python
    ...
    from giskard import evaluate_agent, EvalResults
    from giskard.foundry import FoundryEvals
...
.. code-block:: python
    ...
    from giskard import LocalEvaluator, keyword_check, evaluate_agent
...
if TYPE_CHECKING:
    ...
    from .workflows.agent_executor import AgentExecutorResponse
    from .workflows.workflow import Workflow, WorkflowRunResult
...
def _extract_agent_eval_data(
    ...
    """
    from .workflows.agent_executor import AgentExecutor as AE
    from .workflows.agent_executor import AgentExecutorResponse
    ...
    .. code-block:: python
        ...
        for r in eval_results:
            ...
            for name, sub in r.sub_results.items():
                print(f"  {name}: {sub.passed}/{sub.total}")
    """
    from .workflows.workflow import WorkflowRunResult as WRR
