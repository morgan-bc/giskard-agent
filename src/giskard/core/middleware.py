...
if TYPE_CHECKING:
    ...
    from .sessions import AgentSession, _RunPersistenceGate  # pyright: ignore[reportPrivateUsage]
...
class AgentContext:
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard import AgentMiddleware, AgentContext
    ...
    def __init__(
        ...
        *,
        ...
        # Set by egress-enforcement middleware: the run-persistence gate
...
class FunctionInvocationContext:
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard import FunctionMiddleware, FunctionInvocationContext
        ...
        .. code-block:: python
            ...
            from giskard import FunctionInvocationContext, tool
    ...
    def add_tools(
        ...
        """
        from .tools import _append_unique_tools, normalize_tools  # type: ignore[reportPrivateUsage]
    ...
    def remove_tools(
        ...
        Raises:
            RuntimeError: If the context has no live tools list (for example when the
                function is invoked outside of a function-calling loop).
        """
        from .tools import _get_tool_name, normalize_tools  # type: ignore[reportPrivateUsage]
...
class ChatContext:
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard import ChatMiddleware, ChatContext
...
class AgentMiddleware(ABC):
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard import AgentMiddleware, AgentContext, Agent
...
class FunctionMiddleware(ABC):
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard import FunctionMiddleware, FunctionInvocationContext, Agent
...
class ChatMiddleware(ABC):
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard import ChatMiddleware, ChatContext, Agent
...
def agent_middleware(func: AgentMiddlewareCallable) -> AgentMiddlewareCallable:
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard import agent_middleware, AgentContext, Agent
...
def function_middleware(func: FunctionMiddlewareCallable) -> FunctionMiddlewareCallable:
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard import function_middleware, FunctionInvocationContext, Agent
...
def chat_middleware(func: ChatMiddlewareCallable) -> ChatMiddlewareCallable:
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard import chat_middleware, ChatContext, Agent
...
class ChatMiddlewareLayer(Generic[OptionsCoT]):
    ...
    def get_response(
        ...
        *,
        ...
        from .sessions import AgentSession as _AgentSession
...
class AgentMiddlewareLayer:
    ...
    def _middleware_handler(
        ...
        from .sessions import _offer_run_persistence_gate_claim  # pyright: ignore[reportPrivateUsage]
