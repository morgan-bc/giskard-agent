...
from .clients import BaseChatClient, SupportsChatGetResponse
...
def _append_unique_tools(
    ...
    *,
    ...
    from .tools import _append_unique_tools as append_unique_tools  # pyright: ignore[reportPrivateUsage]
...
def _get_tool_name(tool: Any) -> str | None:  # pyright: ignore[reportUnusedFunction]
    from .tools import _get_tool_name as get_tool_name  # pyright: ignore[reportPrivateUsage]
...
class SupportsAgentRun(Protocol):
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard.core import SupportsAgentRun
            ...
            class CustomAgent:
                ...
                async def run(self, messages=None, *, stream=False, session=None, **kwargs):
                    if stream:
                        ...
                        async def _stream():
                            from giskard import AgentResponseUpdate
                        ...
                        from giskard import AgentResponse
...
class RawAgent(BaseAgent, Generic[OptionsCoT]):
    ...
    def as_mcp_server(
        ...
        **kwargs: Any,
        ...
        from .mcp import LOG_LEVEL_MAPPING
