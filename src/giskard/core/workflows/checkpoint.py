...
if TYPE_CHECKING:
    ...
    from .runner_context import WorkflowMessage
...
class FileCheckpointStorage:
    ...
    (primitives, datetime, uuid, ...), all ``giskard`` internal types, and OpenAI SDK types
    ...
    async def save(self, checkpoint: WorkflowCheckpoint) -> CheckpointID:
        ...
        Returns:
            The unique ID of the saved checkpoint.
        """
        from .checkpoint_encoding import encode_checkpoint_value
    ...
    async def load(self, checkpoint_id: CheckpointID) -> WorkflowCheckpoint:
        ...
        from .checkpoint_encoding import decode_checkpoint_value
