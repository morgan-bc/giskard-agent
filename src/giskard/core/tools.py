...
class FunctionTool(SerializationMixin):
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard import FunctionTool, tool
...
async def _auto_invoke_function(
    ...
    *,
    ...
    from .middleware import MiddlewareTermination
...
async def _execute_single_function_call(
    ...
    *,
    ...
    from .middleware import MiddlewareTermination
    from .sessions import _suspend_run_persistence_gate  # pyright: ignore[reportPrivateUsage]
    from .types import Content
...
def _ensure_function_invocation_limit_fallback_response(response: ChatResponse[Any]) -> bool:
    ...
    from .types import Content, Message
...
def _function_invocation_limit_fallback_update() -> ChatResponseUpdate:
    from .types import ChatResponseUpdate, Content
...
def _get_tool_approval_state(invocation_session: AgentSession | None) -> dict[str, Any] | None:
    ...
    from .harness.tool_approval import ToolApprovalState
...
def _messages_and_updates_for_terminal_contents(
    ...
    from .types import ChatResponseUpdate, Message
...
class FunctionInvocationLayer(Generic[OptionsCoT]):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        from .middleware import categorize_middleware
    ...
    def _get_function_middleware_pipeline(
        ...
        from .middleware import FunctionMiddlewarePipeline
    ...
    async def _get_response_with_function_invocation(
        ...
        *,
        ...
        from .types import ChatResponse, add_usage_details
    ...
    def get_response(
        ...
        *,
        ...
        from .middleware import _as_middleware_list, categorize_middleware  # pyright: ignore[reportPrivateUsage]
        from .types import (
            ChatResponse,
            ResponseStream,
        )
