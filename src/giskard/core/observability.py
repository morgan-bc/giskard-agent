...
from giskard import __version__ as version_info
...
logger = logging.getLogger("giskard_agent")
...
class OtelAttr(str, Enum):
    ...
    MEASUREMENT_FUNCTION_TAG_NAME = "giskard_agent.function.name"
    MEASUREMENT_FUNCTION_INVOCATION_DURATION = "giskard_agent.function.invocation.duration"
    giskard_agent_GEN_AI_SYSTEM = "microsoft.giskard_agent"
...
def create_resource(
    ...
    **attributes: Any,
    ...
    - OTEL_SERVICE_NAME: The name of the service (defaults to "giskard_agent")
    ...
    Args:
        service_name: Override the service name. If not provided, reads from
            OTEL_SERVICE_NAME environment variable or defaults to "giskard_agent".
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard_agent.observability import create_resource
    ...
    if service_name is None:
        service_name = os.getenv("OTEL_SERVICE_NAME", "giskard_agent")
...
def create_metric_views() -> list[View]:
    ...
    return [
        View(instrument_name="giskard_agent*"),
...
class ObservabilitySettings:
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard_agent import ObservabilitySettings
...
def get_tracer(
    instrumenting_module_name: str = "giskard_agent",
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard_agent import get_tracer
...
def get_meter(
    ...
    Args:
        name: The name of the instrumenting library. Default is "giskard_agent".
        version: The version of giskard_agent. Default is the current version
            of the package.
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard_agent import get_meter
...
def configure_otel_providers(
    *,
    ...
    Note:
        By default, the Agent Framework emits metrics with the prefixes `giskard_agent`
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard_agent.observability import configure_otel_providers
        ...
        .. code-block:: python
            ...
            from giskard_agent.observability import enable_sensitive_telemetry
...
class ChatTelemetryLayer(Generic[OptionsCoT]):
    ...
    def get_response(
        ...
        *,
        ...
        """
        from .types import ChatResponse, ChatResponseUpdate, ResponseStream  # type: ignore[reportUnusedImport]
...
class EmbeddingTelemetryLayer(Generic[EmbeddingInputT, EmbeddingT, EmbeddingOptionsT]):
    ...
    async def get_embeddings(
        ...
        *,
        ...
        from .types import GeneratedEmbeddings  # type: ignore[reportUnusedImport]
...
class AgentTelemetryLayer:
    ...
    def run(
        ...
        *,
        ...
        from .types import merge_chat_options
...
def _start_streaming_span(attributes: dict[str, Any], span_name_attribute: str) -> trace.Span:
    ...
    - Ending the span via cleanup hooks on the wrapped
      :class:`~giskard_agent._types.ResponseStream`.
...
def _to_otel_part(content: Content) -> dict[str, Any] | None:
    ...
    from .types import _get_data_bytes_as_str  # pyright: ignore[reportPrivateUsage]
...
def _mark_inner_response_telemetry_captured(
    ...
    if response.usage_details:
        ...
        if accumulated is not None:
            from .types import add_usage_details
