...
from giskard.core.clients import BaseChatClient
from giskard.core.compaction import (
...
from giskard.core.middleware import ChatAndFunctionMiddlewareTypes, ChatMiddlewareLayer
from giskard.core.settings import SecretString
from giskard.core.telemetry import USER_AGENT_KEY, mark_feature_used
from giskard.core.tools import (
...
from giskard.core.types import (
    Annotation,
    ChatOptions,
    ChatResponse,
    ChatResponseUpdate,
...
from giskard.core.exceptions import (
    ChatClientException,
    ChatClientInvalidRequestException,
)
from giskard.core.observability import ChatTelemetryLayer
...
logger = logging.getLogger("giskard.openai")
    ...
    def __init__(
        ...
        *,
        ...
        Keyword Args:
            model: Model identifier to use for the request. When not provided, the constructor
                reads ``OPENAI_CHAT_MODEL`` and then ``OPENAI_MODEL``.
            api_key: API key override. Maps to ``OPENAI_API_KEY``. A callable token provider is also accepted.
            org_id: OpenAI organization ID. Resolved from ``OPENAI_ORG_ID`` when not provided.
            base_url: Base URL override. Maps to ``OPENAI_BASE_URL``.
            default_headers: Additional HTTP headers.
            async_client: Pre-configured OpenAI client.
            instruction_role: Role for instruction messages (for example ``"system"``).
            compaction_strategy: Optional per-client compaction override.
            ...
            async def _stream() -> AsyncIterable[ChatResponseUpdate]:
                ...
                if continuation_token is not None:
                    ...
                    try:
                        ...
                        # Read headers defensively: telemetry instrumentors wrap the streaming response
        ...
        *,
        ...
        Examples:
            .. code-block:: python
                ...
                from giskard.core.openai import OpenAIChatClient
    ...
    def _prepare_content_for_openai(
        ...
        *,
        ...
        match content.type:
            case "text":
                if role == "assistant":
                    # Assistant history is represented as output text items; validation
        ...
        *,
        ...
        Examples:
            .. code-block:: python
                ...
                from giskard.core.openai import OpenAIChatOptions
...
def _apply_openai_chat_client_docstrings() -> None:
    ...
    from giskard.core.clients import BaseChatClient
    from giskard.core._docstrings import apply_layered_docstring
