...
from giskard.core.settings import SecretString, load_settings
from giskard.core.telemetry import APP_INFO, prepend_agent_framework_to_user_agent
from giskard.core.exceptions import SettingNotFoundError
...
from .feature_usage import create_feature_usage_http_client
...
class OpenAISettings(TypedDict, total=False):
    ...
    Examples:
        .. code-block:: python
            ...
            from giskard.core.openai import OpenAISettings
...
def load_openai_service_settings(
    *,
    ...
    The OpenAI clients read from ``OPENAI_*`` variables.
    """
