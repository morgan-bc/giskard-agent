...
from giskard.core.compaction import CompactionStrategy, TokenizerProtocol
...
logger = logging.getLogger("giskard.core.openai")
...
class RawOpenAIChatCompletionClient(
        ...
        *,
        ...
        Examples:
            .. code-block:: python
                ...
                from giskard.core.openai import OpenAIChatCompletionClient
    ...
    def _prepare_tools_for_openai(
        ...
        Note:
            :class:`ValueError`. Use :class:`~giskard.core.openai.OpenAIChatClient`
    ...
    def _prepare_options(self, messages: Sequence[Message], options: Mapping[str, Any]) -> dict[str, Any]:
        ...
        from giskard.core.types import prepend_instructions_to_messages, validate_tool_mode
        ...
        *,
        ...
        Examples:
            .. code-block:: python
                ...
                from giskard.core.openai import OpenAIChatCompletionOptions
